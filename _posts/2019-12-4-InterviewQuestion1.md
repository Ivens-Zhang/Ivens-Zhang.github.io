...
**2.position定位属性和相关的关系, 清除浮动。**

例如relative占用文档流，而absolute和fixed却不占用，还有relative和absolute结合使用会有变化，一定要搞懂。

**3.display相关属性，常用的block、inline、等等都要弄明白。**
