...
- [正文](#%e6%ad%a3%e6%96%87)
  ...
  - [条件渲染、列表渲染](#%e6%9d%a1%e4%bb%b6%e6%b8%b2%e6%9f%93%e5%88%97%e8%a1%a8%e6%b8%b2%e6%9f%93)
    ...
    - [Vue中对数组进行增删的方法](#vue%e4%b8%ad%e5%af%b9%e6%95%b0%e7%bb%84%e8%bf%9b%e8%a1%8c%e5%a2%9e%e5%88%a0%e7%9a%84%e6%96%b9%e6%b3%95)
...
希望响应式地改变页面遍历的数组,需要使用以上的方法,如果只用`vm.list[0]= 2` 数组值会发生变化,但是页面不会刷新.或直接改变list数组,如`vm.list={1,2,3,4}`.

如果想让对象进行响应式增删,可以使用第二种方法,直接重新定义对象.
